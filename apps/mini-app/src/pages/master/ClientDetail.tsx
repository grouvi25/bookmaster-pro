    ...
    <div className="p-4 pb-20 animate-fade-in">
      ...
      <Card className="mb-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="bg-tg-secondary rounded-xl p-2">
            <div className="font-bold text-lg">{client.visit_count}</div>
            <div className="text-[10px] text-tg-hint">Визитов</div>
          </div>
          <div className="bg-tg-secondary rounded-xl p-2">
            ...
            <div className="text-[10px] text-tg-hint">Выручка, ₽</div>
          </div>
          <div className="bg-tg-secondary rounded-xl p-2">
            <div className="font-bold text-lg">{client.no_show_count}</div>
            <div className="text-[10px] text-tg-hint">Неявок</div>
          </div>
        </div>
      </Card>
